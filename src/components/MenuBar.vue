<template>
  <div class="row justify-center text-primary full-width">
    <q-btn-group class="col-xs-6 col-sm-6 col-lg-2 border-radius">
      <!--q-btn flat class="col-6 bg-white q-py-lg q-px-lg text-bold" to="/" label="Start" icon="o_home"></q-btn-->
      <q-btn flat class="col-xs-12 bg-white q-py-lg q-px-lg text-bold" to="/models" label="Modelle"
